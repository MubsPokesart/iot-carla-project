"""Functions for checking determinism in the CARLA simulator."""
...
def write_summary(run_id, summary_data, output_dir="artefacts"):
...
def compare_summaries(run_id1, run_id2, output_dir="artefacts"):
